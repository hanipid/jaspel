  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        {% if jenisRuang == "kantor" or auth.getIdentity()["profile"] == "Pelayanan" %}
      ...
      <table id="dataTable" class="table table-bordered table-striped" align="center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td width="2%">
              {% if (auth.getIdentity()["profile"] == "Kepegawaian" and pr.ruangan.jenisRuang == "kantor") or (auth.getIdentity()["profile"] == "Pelayanan") %}
