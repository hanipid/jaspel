...
(27,	'Ruangan',	'',	'ruangan',	'ruangan',	22,	16),
...
(30,	'Pelayanan',	'',	'setins-pelayanan',	'setins-pelayanan',	21,	18),
...
(2565,	1,	'users',	'create'),
(2566,	1,	'users',	'delete'),
(2567,	1,	'users',	'changePassword'),
(2568,	1,	'profiles',	'index'),
(2569,	1,	'profiles',	'search'),
(2570,	1,	'profiles',	'edit'),
(2571,	1,	'profiles',	'create'),
(2572,	1,	'profiles',	'delete'),
(2573,	1,	'permissions',	'index'),
(2574,	1,	'permissions',	'edit'),
(2575,	1,	'menus',	'index'),
(2576,	1,	'menus',	'create'),
(2577,	1,	'menus',	'edit'),
(2578,	1,	'menus',	'delete'),
(2579,	1,	'menus',	'order'),
(2580,	1,	'setpeg-data-pegawai',	'index'),
(2581,	1,	'setpeg-data-pegawai',	'create'),
(2582,	1,	'setpeg-data-pegawai',	'edit'),
(2583,	1,	'setpeg-data-pegawai',	'delete'),
(2584,	1,	'setpeg-data-pegawai',	'uploadBerkas'),
(2585,	1,	'setpeg-data-pegawai',	'deleteFile'),
(2586,	1,	'setpeg-data-golongan',	'index'),
(2587,	1,	'setpeg-data-golongan',	'create'),
(2588,	1,	'setpeg-data-golongan',	'edit'),
(2589,	1,	'setpeg-data-golongan',	'delete'),
(2590,	1,	'setpeg-jabatan',	'index'),
(2591,	1,	'setpeg-jabatan',	'create'),
(2592,	1,	'setpeg-jabatan',	'edit'),
(2593,	1,	'setpeg-jabatan',	'delete'),
(2594,	1,	'setpeg-pangkat',	'index'),
(2595,	1,	'setpeg-pangkat',	'create'),
(2596,	1,	'setpeg-pangkat',	'edit'),
(2597,	1,	'setpeg-pangkat',	'delete'),
(2598,	1,	'setpeg-jenjang',	'index'),
(2599,	1,	'setpeg-jenjang',	'create'),
(2600,	1,	'setpeg-jenjang',	'edit'),
(2601,	1,	'setpeg-jenjang',	'delete'),
(2602,	1,	'setpeg-golongan-ruang',	'index'),
(2603,	1,	'setpeg-golongan-ruang',	'create'),
(2604,	1,	'setpeg-golongan-ruang',	'edit'),
(2605,	1,	'setpeg-golongan-ruang',	'delete'),
(2606,	1,	'setjas-jenis-jaspel',	'index'),
(2607,	1,	'setjas-jenis-jaspel',	'create'),
(2608,	1,	'setjas-jenis-jaspel',	'edit'),
(2609,	1,	'setjas-jenis-jaspel',	'delete'),
(2610,	1,	'setjas-jenis-jaspel',	'createPTambahan'),
(2611,	1,	'setjas-jenis-jaspel',	'editPTambahan'),
(2612,	1,	'setjas-jenis-jaspel',	'deletePTambahan'),
(2613,	1,	'setjas-persentase-jaspel',	'index'),
(2614,	1,	'setjas-persentase-jaspel',	'create'),
(2615,	1,	'setjas-persentase-jaspel',	'edit'),
(2616,	1,	'setjas-persentase-jaspel',	'delete'),
(2617,	1,	'setjas-persentase-direksi',	'index'),
(2618,	1,	'setjas-persentase-direksi',	'create'),
(2619,	1,	'setjas-persentase-direksi',	'edit'),
(2620,	1,	'setjas-persentase-direksi',	'delete'),
(2621,	1,	'setjas-persentase-manajemen',	'index'),
(2622,	1,	'setjas-persentase-manajemen',	'create'),
(2623,	1,	'setjas-persentase-manajemen',	'edit'),
(2624,	1,	'setjas-persentase-manajemen',	'delete'),
(2625,	1,	'ruangan',	'index'),
(2626,	1,	'ruangan',	'create'),
(2627,	1,	'ruangan',	'edit'),
(2628,	1,	'ruangan',	'delete'),
(2629,	1,	'ruangan',	'createPelayanan'),
(2630,	1,	'ruangan',	'editPelayanan'),
(2631,	1,	'ruangan',	'deletePelayanan'),
(2632,	1,	'ruangan',	'getJenisPelayanan'),
(2633,	1,	'setins-pengajuan-jaspel',	'index'),
(2634,	1,	'setins-pengajuan-jaspel',	'create'),
(2635,	1,	'setins-pengajuan-jaspel',	'edit'),
(2636,	1,	'setins-pengajuan-jaspel',	'createPendapatan'),
(2637,	1,	'setins-pengajuan-jaspel',	'createDirect'),
(2638,	1,	'setins-pengajuan-jaspel',	'createSplit'),
(2639,	1,	'setins-pelayanan',	'index'),
(2640,	1,	'setins-pelayanan',	'create'),
(2641,	1,	'setins-pelayanan',	'edit'),
(2642,	1,	'setins-pelayanan',	'delete'),
(2643,	1,	'pengajuan-jaspel',	'index'),
(2644,	1,	'pengajuan-jaspel',	'create'),
(2645,	1,	'pengajuan-jaspel',	'edit'),
(2646,	1,	'pengajuan-jaspel',	'delete'),
(2647,	1,	'pengajuan-jaspel',	'createKlaim'),
(2648,	1,	'pengajuan-jaspel',	'createPesan'),
(2649,	1,	'pegawai-ruangan',	'index'),
(2650,	1,	'pegawai-ruangan',	'create'),
(2651,	1,	'pegawai-ruangan',	'edit'),
(2652,	1,	'pegawai-ruangan',	'delete'),
(2653,	1,	'dashboard-instalasi',	'index');
...
(6,	0,	0,	'user',	'user@example.com',	'$2y$08$bXhJN01NbC8rbVVXUUR1WOkhxqv7pnIHQNYCARTpSH9H6RrgcJzqe',	'N',	2,	'N',	'N',	'Y'),
