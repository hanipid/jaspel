...
(4,	'non konversi',	'Jenis Empats',	'1234',	'tidak aktif'),
...
INSERT INTO `pegawai` (`idPegawai`, `jenisKelamin`, `namaPegawai`, `gelarDepan`, `gelarBelakang`, `posisiStatus`, `nip`, `tempatLahir`, `tanggalLahir`, `eselon`, `indexIB`, `indexIK`, `indexIR`, `indexIE`, `indexIP`, `indexPerform`, `gajiPokok`, `statusPns`, `tmpPns`, `idGolongan`, `idPangkat`, `idGolonganRuang`, `tmt`, `telepon`, `email`, `idJenjang`, `namaSekolah`, `idJabatan`, `bank`, `noRekening`, `alamat`, `keterangan`, `statusAktif`, `foto`) VALUES
(1,	'laki - laki',	'husain',	'ab',	'bv',	'dokter',	'12981312938',	'surabaya',	'1990-01-10',	'I',	12,	21,	23,	23,	12,	20,	20000000.00,	'pns',	'2012-10-10',	3,	2,	1,	'2012-12-12',	'12312',	'asd@asd.cas',	1,	'sma bla',	1,	'bca',	'1231231231',	'jalan',	'ajskda',	'aktif',	'husainZjJlUmpEbCtnRzg9.jpeg'),
(2,	'perempuan',	'lala',	'aa',	'bb',	'',	'721872',	'Malang',	'1990-01-09',	'1',	78,	22,	67,	72,	63,	72,	127.00,	'non pns',	'2009-09-01',	3,	1,	1,	'2010-09-09',	'8218921',	'asjdn@jna.csa',	1,	'smun',	1,	'bca',	'129182',	'tangga',	'qwqjk',	'aktif',	NULL),
(3,	'perempuan',	'lala',	'aa',	'bb',	'',	'721872',	'Malang',	'1990-01-09',	'1',	78,	22,	67,	72,	63,	72,	127.00,	'non pns',	'2009-09-01',	3,	1,	1,	'2010-09-09',	'8218921',	'asjdn@jna.csa',	1,	'smun',	1,	'bca',	'129182',	'tangga',	'qwqjk',	'',	NULL),
(4,	'perempuan',	'lala',	'aa',	'bb',	'',	'721872',	'Malang',	'1990-01-09',	'1',	78,	22,	67,	72,	63,	72,	127.00,	'non pns',	'2009-09-01',	3,	1,	1,	'2010-09-09',	'8218921',	'asjdn@jna.csa',	1,	'smun',	1,	'bca',	'129182',	'tangga',	'qwqjk',	'',	NULL),
(5,	'perempuan',	'lala',	'aa',	'bb',	'bukandokter',	'721872',	'Malang',	'1990-01-09',	'1',	78,	22,	67,	72,	63,	72,	127.00,	'non pns',	'2009-09-01',	3,	1,	1,	'2010-09-09',	'8218921',	'asjdn@jna.csa',	1,	'smun',	1,	'bca',	'129182',	'tangga',	'qwqjk',	'keluar',	NULL),
(7,	'perempuan',	'lalas',	'aa',	'bb',	'dokter',	'721872',	'Malang',	'1990-01-09',	'1',	78,	22,	67,	72,	63,	72,	127.00,	'non pns',	'2009-09-01',	3,	1,	1,	'2010-09-09',	'8218921',	'asjdn@jna.csa',	1,	'smun',	1,	'bca',	'129182',	'tangga',	'qwqjk',	'tidak aktif',	NULL),
(8,	'perempuan',	'Karlie',	'Dr',	'Sp. KK',	'dokter',	'12818728',	'Magelang',	'1970-01-21',	'1',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	''),
(9,	'laki - laki',	'',	'',	'',	'dokter',	'',	'',	'0000-00-00',	'',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	''),
(10,	'laki - laki',	'Husain',	'',	'',	'dokter',	'',	'',	'0000-00-00',	'',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	''),
(11,	'perempuan',	'Nathany',	'Dr',	'Sp.KG',	'dokter',	'8712817',	'Surabaya',	'1990-10-10',	'-',	0,	0,	0,	0,	0,	0,	0.00,	'',	'0000-00-00',	0,	0,	0,	'0000-00-00',	'',	'',	0,	'',	0,	'',	'',	'',	'',	'',	'Nathany.'),
(12,	'perempuan',	'Nathany',	'Dr',	'Sp.KG',	'dokter',	'8712817',	'Surabaya',	'1990-10-10',	'-',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	'Nathany.image/png'),
(13,	'perempuan',	'Nathany',	'Dr',	'Sp.KG',	'dokter',	'8712817',	'Surabaya',	'1990-10-10',	'-',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	'Nathany.png'),
(14,	'perempuan',	'Nathany',	'Dr',	'Sp.KG',	'dokter',	'8712817',	'Surabaya',	'1990-10-10',	'-',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	'Nathany.jpg'),
(15,	'laki - laki',	'Johan Nathan el',	'Dr',	'Sp.KAG',	'dokter',	'',	'',	'0000-00-00',	'',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	''),
(16,	'perempuan',	'Nanny',	'Dr',	'Sp.KK',	'dokter',	'',	'',	'0000-00-00',	'',	0,	0,	0,	0,	0,	0,	0.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	'Nannya1BVZlU2WThtWTQ9.jpg'),
(17,	'laki - laki',	'Anis',	'',	'',	'dokter',	'',	'',	'0000-00-00',	'',	10,	21,	43,	543,	12,	42,	127.00,	'pns',	'0000-00-00',	1,	1,	1,	'0000-00-00',	'',	'',	1,	'',	1,	'',	'',	'',	'',	'aktif',	'Anisab2cwVjVxMkRDVmM9.jpeg');
